...
public class NBlocks {
    ...
    public static Block ClockBlock = new ClockB().setTexturePath(":ClockBlock").setCreativeTab(NMain.tabNazikTV);
    public static Block AdvancFur = new FurAPI(false).setBlockName("AdvancFur");
    public static Block AdvancFurAct = new FurAPI(true).setBlockName("AdvancFurAct");
    public static Block FASBlock = new FASBlock().setCreativeTab(NMain.tabNazikTV).setBlockTextureName(NMain.modid + ":FASB1"),
    ...
    public static void registerBlocks() {
        ...
        GameRegistry.registerBlock(FASBlock, "FASBlock");//.setCreativeTab(NMain.tabNazikTV);
