...
import ua.naziktv.utility.common.blocks.AdvancetFur;
import ua.naziktv.utility.common.gui.recipes.AdvFurRecipes;
 ...
 */
public class TileEntityAdvancFur extends TileEntity implements ISidedInventory {
    ...
    public String getInventoryName() {
        return this.hasCustomInventoryName() ? this.furnaceName : "Emerald furnace";
    }
    ...
    public void readFromNBT(NBTTagCompound tagCompound) {
        ...
        NBTTagList tagList = tagCompound.getTagList("Items", 1);
    ...
    public void updateEntity() {
        ...
        if (flag != this.furnaceBurnTime > 0) {
            flag1 = true;
            AdvancetFur.updateBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
        }
    ...
    private boolean canSmelt() {
        if (this.furnaceItemStacks[0] == null) {
            return false;
                ...
                ItemStack itemstack = AdvFurRecipes.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
                if (itemstack == null) return false;
                else if (this.furnaceItemStacks[2] == null) return true;
                else if (!this.furnaceItemStacks[2].isItemEqual(itemstack)) return false;
                else {
