package ua.naziktv.utility.common.container;
...
public class ContainerAdwFur extends Container {
    ...
    public ContainerAdwFur(InventoryPlayer player, TileEntityAdvancFur tileEntityFurnace){
        ...
        //this.addSlotToContainer(new Slot(tileEntityFurnace, 2, 59, 53));
    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int par2){
        ...
        if(slot != null && slot.getHasStack()){
            ...
            if(par2 == 2){
                ...
                if(AdvFurRecipes.smelting().getSmeltingResult(itemstack1) != null){
                    if(!this.mergeItemStack(itemstack1, 0, 1, false)){
                        return null;
                    }
                }else if(TileEntityAdvancFur.isItemFuel(itemstack1)){
